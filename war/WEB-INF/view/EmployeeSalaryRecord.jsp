...
<div class="container" id="center">
      ...
      <div class="container" id="innercenter">
		...
		<div id="tableview">
				...
				<c:set var="salary" value="${requestScope.salaryEntity}"></c:set>		
				  
  				 
                <center><table class="myprofile">
  				<tbody>
  					<tr>
  				 		<th colspan="2"><center>Employee Salary Slip </center></th>
  				  	</tr>
  		 		
  		 		
  		 			<tr><td>Employee Id</td><td><c:out value="${salary.properties.EmployeeId}"></c:out></td></tr>
  					<tr><td>Email</td><td><c:out value="${salary.properties.Email}"></c:out></td></tr>
  					<tr><td>Date</td><td><c:out value="${salary.properties.Date}"></c:out></td></tr>
  				    <tr><td>Basic Pay</td><td><c:out value="${salary.properties.BasicPay}"></c:out></td></tr>
  				    <tr><td>Net Pay</td><td><c:out value="${salary.properties.NetPay}"></c:out></td></tr>
  					<tr><td>Provident Fund</td><td><c:out value="${salary.properties.PF}"></c:out></td></tr>
  					<tr><td>LOPDays</td><td><c:out value="${salary.properties.LOPDays}"></c:out></td></tr>
