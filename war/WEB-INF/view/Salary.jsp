...
<link rel="stylesheet" type="text/css" href="resources/stylesheet/Salary.css">
  		...
  		<div class="container" id="innercenter">
            ...
            <li><a href="/homePage">LogOut</a></li>
  			...
  			<div class="col-sm-10" id="topinnerright">
  				  ...
  				  <form id="salary" class="form-horizontal" action="/computeemployeesalary" method="post" onsubmit="return validateData()">
  				     
  				     
  				  <div class="form-group">
                    <label for="basicSalary" class="control-label col-xs-4">Basic Pay</label>
                        <div class="col-xs-6">
                            <input type="text" class="form-control" name="basicSalary" id="basicSalary" placeholder="Basic Salary">
                        </div>
                  </div>
