...
<title>Recruitment</title> 
 ...
 <script  src="resources/script/Recruitment.js"></script>

<link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css">
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
  <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>
<link rel="stylesheet" type="text/css" href="resources/stylesheet/Recruitment.css">
<link rel="stylesheet" type="text/css" href="resources/stylesheet/Recruitment.css">
 ...
 -->      		</div>
  		...
  		<div class="container" id="innercenter">
            ...
            <!-- <div class="bs-example" id="formalign"> -->
            	...
            	<c:set var="employeeEntity" value="${requestScope.createError}"></c:set>
            	
            	
            	
            	<c:choose>
 					<c:when test="${employeeEntity!=null}">
 	 					<center><p style="color:red"><c:out value="${employeeEntity}"></c:out></p></center>
 					</c:when>
               ...
               <form class="form-horizontal" action="/addemployee" name="recruit" method="post" onsubmit="return validateUserData()">
